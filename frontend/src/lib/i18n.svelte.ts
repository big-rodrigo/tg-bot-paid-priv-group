...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ── Backup ──
  'settings.backup': { en: 'Database Backup', 'pt-BR': 'Backup do Banco de Dados' },
  'settings.backupHint': { en: 'Automatic database backups sent to the admin Telegram chat.', 'pt-BR': 'Backups automáticos do banco de dados enviados ao chat de administrador no Telegram.' },
  'settings.backupEnabled': { en: 'Enable automatic backups', 'pt-BR': 'Ativar backups automáticos' },
  'settings.backupInterval': { en: 'Backup interval', 'pt-BR': 'Intervalo de backup' },
  'settings.backupEvery3h': { en: 'Every 3 hours', 'pt-BR': 'A cada 3 horas' },
  'settings.backupEvery6h': { en: 'Every 6 hours', 'pt-BR': 'A cada 6 horas' },
  'settings.backupEvery12h': { en: 'Every 12 hours', 'pt-BR': 'A cada 12 horas' },
  'settings.backupEvery24h': { en: 'Every 24 hours', 'pt-BR': 'A cada 24 horas' },
  'settings.lastBackup': { en: 'Last backup:', 'pt-BR': 'Último backup:' },
  'settings.lastBackupNever': { en: 'Never', 'pt-BR': 'Nunca' },
  'settings.backupNow': { en: 'Backup Now', 'pt-BR': 'Fazer Backup Agora' },
  'settings.backupRunning': { en: 'Backup in progress…', 'pt-BR': 'Backup em andamento…' },
  'settings.backupSuccess': { en: 'Backup completed and sent to admin chat!', 'pt-BR': 'Backup concluído e enviado ao chat do administrador!' },
  'settings.backupError': { en: 'Backup failed', 'pt-BR': 'Falha no backup' },
  'settings.backupNoChatId': { en: 'Send any admin command (/admin) to the bot first to register your chat ID.', 'pt-BR': 'Envie qualquer comando de admin (/admin) ao bot primeiro para registrar seu chat ID.' },
  'settings.restore': { en: 'Restore Database', 'pt-BR': 'Restaurar Banco de Dados' },
  'settings.restoreHint': { en: 'Upload a backup file received from the bot to restore the database.', 'pt-BR': 'Envie um arquivo de backup recebido do bot para restaurar o banco de dados.' },
  'settings.restoreSelectFile': { en: 'Select backup file(s)…', 'pt-BR': 'Selecionar arquivo(s) de backup…' },
  'settings.restoreWarning': { en: 'This will replace ALL current data. This action cannot be undone.', 'pt-BR': 'Isso substituirá TODOS os dados atuais. Esta ação não pode ser desfeita.' },
  'settings.restoreConfirm': { en: 'Are you sure you want to restore the database? All current data will be lost.', 'pt-BR': 'Tem certeza de que deseja restaurar o banco de dados? Todos os dados atuais serão perdidos.' },
  'settings.restoreBtn': { en: 'Restore', 'pt-BR': 'Restaurar' },
  'settings.restoring': { en: 'Restoring…', 'pt-BR': 'Restaurando…' },
  'settings.restoreSuccess': { en: 'Database restored successfully!', 'pt-BR': 'Banco de dados restaurado com sucesso!' },
};
